...
<img width="526" height="298" alt="image" src="https://github.com/user-attachments/assets/3b90652b-3e89-4b8c-a808-8082c26e74e0" />
...
Identify a critical-path cell via timing analysis
Duplicate that cell/module
Redistribute the downstream connections across the original and the clone
Re-place and re-route
Re-check timing/power to confirm the improvement actually helped
<img width="462" height="286" alt="image" src="https://github.com/user-attachments/assets/ae07617f-c1fc-41c4-b3a4-309adeebed08" />
...
Model the circuit as a directed graph of logic and registers
Move registers across combinational logic to even out path delays
Check that timing constraints and functional equivalence still hold
Settle on the register placement that minimizes the achievable clock period
...
Behavior: q is set to 1 in both the reset and non-reset branches — meaning the flip-flop is functionally redundant and synthesis should optimize it down to a tied-high constant, removing the actual flip-flop entirely.
